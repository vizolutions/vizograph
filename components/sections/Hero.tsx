...
export function Hero() {
  ...
  return (
    <section id="home" className={`${pageGutter} pt-3 sm:pt-4`}>
      <div className="relative isolate overflow-hidden rounded-[2.5rem] ring-1 ring-white/5 glow-field">
        <StreakField className="top-[-14%] h-[92%] opacity-100" />
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 grid-field [mask-image:radial-gradient(70%_60%_at_50%_0%,black,transparent)] opacity-[0.15]"
        />
        ...
        <Container className="relative pt-32 pb-16 text-center sm:pt-40 lg:pt-44">
          ...
          <h1 className="mx-auto mt-6 max-w-4xl font-display text-[clamp(2.75rem,6vw,4.75rem)] leading-[1.02] font-semibold tracking-tight text-balance">
            {first} {second}{" "}
            <span className="bg-linear-to-r from-accent via-accent-deep to-accent-soft bg-clip-text text-transparent">
              {third}
            </span>
          </h1>
          ...
          <div className="relative mx-auto mt-16 max-w-5xl lg:mt-20">
            <div
              aria-hidden
              className="absolute inset-x-8 -top-6 h-24 rounded-full bg-accent/25 blur-3xl"
            />
            <HeroVisual />
          </div>
        </Container>
